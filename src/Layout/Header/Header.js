                ...
                <nav className='header__nav'>
                    <div className='header__nav-left'>
                        ...
                        <ul className='header__nav-list'>
                            ...
                            <Link to={'/service'} className={`header__nav-item ${section === 2 && 'header__nav-item-active'}`}
                            onClick={() => setSection(2)}>Сервисный центр</Link>
                            <li className={`header__nav-item ${section === 3 && 'header__nav-item-active'}`}
                            onClick={() => setSection(3)}>Интернет-магазин Dily.ru</li>
                            <Link to={'/buying'} className={`header__nav-item ${section === 4 && 'header__nav-item-active'}`}
                    ...
                    <div className='header__nav-right'>
                        ...
                        </div>
                        {
                            user.email.length
                                ?
                                <Link to='auth' className='header__nav-auth'>
                            <span>
                        ...
                        </span> {user.displayName} / Выйти</Link>
                                :
                                <Link to='auth' className='header__nav-auth'>
                            <span>
                                <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg"><path
