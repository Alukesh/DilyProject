...
const Header = () => {
    ...
    const handleNavClick = (int) => {
        localStorage.setItem('section', int)
        setSection(int)
        setMenuOpen(false)
    }
    const handleLogOut = () => {
            ...
            <div className='container'>
                <nav className='header__nav'>
                    ...
                    <div className='header__nav-right'>
                        ...
                        <BiCategoryAlt className='header__nav-burger' onClick={() => setMenuOpen(!menuOpen)}/>
